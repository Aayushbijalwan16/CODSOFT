...
listbox = tk.Listbox(window, width=100, bg="grey", fg="black")
listbox.pack(pady=20)

entry = tk.Entry(window, font=("Fixedsys", 18), width=40)
entry.pack(pady=10)
...
add_button = tk.Button(button_frame, text="Add", bg="teal", fg="black", command=add_task)
add_button.grid(row=0, column=0, padx=5)

edit_button = tk.Button(button_frame, text="Edit", bg="orange", fg="black", command=edit_task)
edit_button.grid(row=0, column=1, padx=5)

delete_button = tk.Button(button_frame, text="Delete", bg="red", fg="black", command=delete_task)
